...
class TestSubscription(unittest.TestCase):
    ...
    def test_encode(self):
        with patch('src.subscription.stagenet', return_value=False):
            ...
            self.maxDiff = None
            self.assertEqual(subscription.encode(), 'monero-request:2:')
